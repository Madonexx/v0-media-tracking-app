...
export const CATALOG_DATA: Record<string, SearchResult[]> = {
  movie: [
    ...
    { id: 'm3', title: 'Spiderman: Into the Spiderverse', year: '2018', score: 10, image_url: 'https://en.wikipedia.org/wiki/Spider-Man:_Into_the_Spider-Verse', status: 'terminado', genres: ['Animación', 'Aventura'], synopsis: 'Teen Miles Morales becomes the Spider-Man of his universe.' },
